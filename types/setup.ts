...
export const MISTAKE_TAGS = [
  ...
  'CHASE',
  'COUNTER_TREND',
  'COUNTER_TREND_MISMANAGEMENT',
  'NO_CONFIRMATION',
  'NO_FOLLOW_THROUGH_EXIT',
  'OVERTRADE',
  'OVERTRADING_SAME_IDEA',
  'WRONG_LEVEL',
  'IGNORED_VWAP',
  'IGNORED_STRUCTURE',
  'BAD_STOP',
...
export const MISTAKE_TAG_LABELS: Record<MistakeTag, string> = {
  ...
  COUNTER_TREND_MISMANAGEMENT: 'Counter-trend Mismanagement',
  NO_CONFIRMATION:     'No Confirmation',
  NO_FOLLOW_THROUGH_EXIT: 'No Follow-through Exit',
  OVERTRADE:           'Overtrade',
  OVERTRADING_SAME_IDEA: 'Overtrading Same Idea',
