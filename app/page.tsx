...
const SEED_SETUPS: TradeSetup[] = [
  // ── March 24 (Mon) ── SPY VWAP long, partial exit
  {
    ...
    setupType: 'VWAP',
    thesis:
      'VWAP reclaim after morning flush on above-avg volume. Looking for continuation through 448 with tape confirmation.',
    initialGrade: 'A',
    status: 'open',
  ...
  // ── March 21 (Fri) ── NVDA Breakout long, stopped out
  {
    ...
    setupType: 'Breakout',
    thesis:
      'NVDA breaking out of 5-day consolidation above $920. Volume expanding on the break. Target $930 with stop at $917.',
    initialGrade: 'B',
    status: 'closed',
  ...
  // ── March 20 (Thu) ── QQQ ORB long, full exit
  {
    ...
    setupType: 'ORB',
    thesis:
      'Opening range breakout after tight 5-min range. Clean volume profile, bias for continuation toward prior HOD.',
    initialGrade: 'A',
    status: 'closed',
  ...
  // ── March 20 (Thu) ── AAPL Pullback long (same day, 2nd setup)
  {
    ...
    setupType: 'Pullback',
    thesis:
      'AAPL pulling back to 8EMA on low volume after strong open. Clean risk/reward for a long entry back toward HOD.',
    initialGrade: 'B',
    status: 'closed',
  ...
  // ── March 19 (Wed) ── TSLA Reversal short, full exit
  {
    ...
    setupType: 'Reversal',
    thesis:
      'TSLA rejected at VWAP with heavy volume. Lower highs on the 5-min. Thesis: failed reclaim = flush to LOD.',
    initialGrade: 'A+',
    status: 'closed',
